  ...
  >
    <div class="map-edit-menu">
      <div class="map-edit-button">
        ...
        <el-button @click="endEdit">
          end-edit
        </el-button>
      </div>

      <div
              class="map-edit-input"
      ...
      >
        <div class="edit-input"
            ...
            display: flex;">
          x:
          <el-input @change="syncSt" v-model="vm.structureVec3.x" type="number"/>
          y:
          <el-input @change="syncSt" v-model="vm.structureVec3.y" type="number"/>
          radians:
          <el-input @change="syncSt" v-model="vm.radians" type="number"/>
        </div>
        <el-button @click="changeV">
          submit
        </el-button>
        ...
        <el-input @change="rotateSubject" v-model="vm.subjectVec3.z" type="number"></el-input>
    ...
    methods: {
      ...
      selectNodeMethod(id) {
        ...
        this.$nextTick(() => {
          ...
          setTimeout(() => { //TODO: 自动移动scrollview
            ...
            exeNode.scrollIntoView({behavior: "auto", block: "center", inline: "nearest"});
          });
        });
      },
      ...
      searchStructure(){
        const st = this.$_scene2d.home.curLevel.findByRvtId(this.searchRvtId.toString());
        if(st){
